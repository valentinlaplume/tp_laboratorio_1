 ...
 * \param this Employee*
 * \param id int*
 * \return int retorna -1 ERROR, retorna ID si ok
 */
...
//----------------------------------------------------------------------
/** \brief Valida un nombre y lo carga en la variable Employee
 * \param this Employee*
 * \param id char*
 * \return int  -1 error, 0 si ok
 */
...
//----------------------------------------------------------------------
/** \brief Valida horas, las convierte a entero y lo carga en la variable Employee
 * \param this Employee*
 * \param id char*
 * \return int  -1 error, 0 si ok
 */
...
/** \brief Valida horas y lo carga en la variable Employee
 * \param this Employee*
 * \param id char*
 * \return int  -1 error, 0 si ok
 */
 ...
 * \param this Employee*
 * \param id int*
 * \return int retorna -1 ERROR, retorna horas si ok
 */
...
//----------------------------------------------------------------------
/** \brief Valida sueldo, lo convierte a entero y lo carga en la variable Employee
 * \param this Employee*
 * \param id char*
 * \return int  -1 error, 0 si ok
 */
...
/** \brief Valida sueldo y lo carga en la variable Employee
 * \param this Employee*
 * \param id char*
 * \return int  -1 error, 0 si ok
 */
 ...
 * \param this Employee*
 * \param id int*
 * \return int retorna -1 ERROR, retorna sueldo si ok
 */
